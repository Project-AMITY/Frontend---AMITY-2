            ...
            <div className="prose prose-slate dark:prose-invert max-w-none text-gray-600 dark:text-gray-300">
              ...
              {activeTab === 'schedule' && (
                <div className="animate-in fade-in duration-300">
                  ...
                  <p className="mb-4">
                    Detailed schedule for the {EVENT_DATA.title}.
                  </p>
              ...
              <div className="bg-white dark:bg-surface-dark rounded-xl border border-gray-200 dark:border-gray-800 shadow-lg p-6">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-bold">{EVENT_DATA.date}</p>
                      <p className="text-xs text-gray-500">{EVENT_DATA.time}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="material-symbols-outlined text-gray-400">
                    ...
                    <div>
                      <p className="text-sm font-bold">{EVENT_DATA.location}</p>
                      <p className="text-xs text-gray-500">
                        {EVENT_DATA.subLocation}
                      </p>
                    </div>
                  </div>
                </div>
